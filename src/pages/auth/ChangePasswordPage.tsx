    ...
    <div className="flex min-h-screen items-center justify-center bg-[oklch(0.98_0.002_250)] px-6">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-4">
          <div className="mx-auto w-16 h-16 rounded-md bg-[oklch(0.45_0.2_260)] flex items-center justify-center shadow-lg shadow-[oklch(0.45_0.2_260)]/25">
        ...
        <div className="bg-white rounded-md shadow-xl shadow-black/5 border border-[oklch(0.92_0.01_250)] p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 text-base px-4 pr-12 rounded-md"
                />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                minLength={8}
                className="h-12 text-base px-4 rounded-md"
              />
            </div>
            <Button
              type="submit"
